        ...
        <Element name="about">
          <div className="main__item_about">
            <p>
              ...
              столом был набор на факультет <span>"Прикладной математики"</span>{' '}
              ,с которого и началось мое познание алгоритмизации. Здесь меня
              заставили работать над решениями различной сложности задач.
            </p>
            <p>
